...
namespace engine
{
    ...
    public: 
        ...
        void on_update(const timestep& timestep, heightmap terrain) ;
        void on_update(const timestep& timestep) override;
        ...
        glm::vec3 rotation() const { return m_rotation_angle; }
        void rotation(const glm::vec3& pos) { m_position = pos; update_view_matrix(); }
